...
import com.psl.restapi.user_rest_api.models.User;
import com.psl.restapi.user_rest_api.services.MyService;
    ...
    try{
      ...
      switch (action) {
        ...
        case "createUser": {
          ...
          JsonObject params = context.getParams();
          try {
            service.createUser(ApiHandlerUtils.searchOptionalJsonObjectInJson(params, "body").map(j -> new com.psl.restapi.user_rest_api.models.User(j)).orElse(null),
                            context,
                            res -> {
                            if (res.failed()) {
                              if (res.cause() instanceof ServiceException) {
        ...
        case "getUser": {
          ...
          JsonObject params = context.getParams();
          try {
            service.getUser(ApiHandlerUtils.searchOptionalLongInJson(params, "userId").map(Long::intValue).orElse(null),
                            context,
                            res -> {
                            if (res.failed()) {
                              if (res.cause() instanceof ServiceException) {
        ...
        case "updateUser": {
          ...
          JsonObject params = context.getParams();
          try {
            service.updateUser(ApiHandlerUtils.searchOptionalLongInJson(params, "userId").map(Long::intValue).orElse(null),
                            ApiHandlerUtils.searchOptionalJsonObjectInJson(params, "body").map(j -> new com.psl.restapi.user_rest_api.models.User(j)).orElse(null),
                            context,
                            res -> {
                            if (res.failed()) {
                              if (res.cause() instanceof ServiceException) {
        ...
        case "deleteUsee": {
          ...
          JsonObject params = context.getParams();
          try {
            service.deleteUsee(ApiHandlerUtils.searchOptionalLongInJson(params, "userId").map(Long::intValue).orElse(null),
                            context,
                            res -> {
                            if (res.failed()) {
                              if (res.cause() instanceof ServiceException) {
